...
// ============================================================================
// WIDGET 1: Bagian Atas (Menampilkan data yang sudah di-save)
// ============================================================================
        ...
        children: [
          ...
          const Expanded(
            child: Text(
              ...
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
              overflow: TextOverflow.ellipsis, // Kasih titik-titik kalau kepanjangan
            ),
          ),
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Belum ada data. Tap ikon save untuk menyimpan.',
...
// ============================================================================
// WIDGET 2: Bagian Bawah (Menampilkan list API dengan tombol Save)
// ============================================================================
class DosenListWithSave extends ConsumerWidget {
  final List<DosenModel> dosenList;
  final VoidCallback onRefresh;

  const DosenListWithSave({Key? key, required this.dosenList, required this.onRefresh}) : super(key: key);
            ...
            child: ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () async {
                  ...
                  if (context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('${dosen.name} berhasil disimpan ke local storage')),
                    );
                  }
                },
              ),
